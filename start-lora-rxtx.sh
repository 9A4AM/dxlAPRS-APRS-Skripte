...
#ra02 -p 520 522 521 523 -a -w 17 -F $LORATX -L 127.0.0.1:9702:9799 -f $LORARX -v &
#ra02 -p 579 581 580 582 -a -w 17 -F $LORATX -L 127.0.0.1:9702:9799 -f $LORARX -v &
sleep 1
...
udpbox -R 127.0.0.1:9702 -l 127.0.0.1:10702 -r 127.0.0.1:9999 -d $MYCALL -p 0,1,2,5,6,15,17 -t 590,28 -f p28,29,33,35-39,41-43,46,47,58,59,61,64,91,95,96,123 -k 0/0/20000 -b 600:$DXLPATH/digibeacon.txt -l 127.0.0.1:9799 -v &
sleep 1
