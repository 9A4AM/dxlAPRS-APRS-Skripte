...
#sleep 10
#
# RX only iGate auf 144.800 + 145.825 mit RTL-USB Stick sowie LoRa APRS mit SX127x Chip am GPIO
#
...
#ra02 -p 520 522 521 523 -a -L 127.0.0.1:9702:0 -f $LORARX -v &
#ra02 -p 579 581 580 582 -a -L 127.0.0.1:9702:0 -f $LORARX -v &
sleep 1
...
udpbox -R 127.0.0.1:9201 -l 127.0.0.1:10201 -r 127.0.0.1:9999 -R 127.0.0.1:9202 -l 127.0.0.1:10202 -r 127.0.0.1:9999 -R 127.0.0.1:9702 -l 127.0.0.1:10702 -r 127.0.0.1:9999 -v &
sleep 1

# udpgate4 ist das iGate, welches alle Daten an APRS-IS weiterleitet und das Webinterface bereitstellt
udpgate4 -s $MYCALL -R 127.0.0.1:0:10201#144800 -R 127.0.0.1:0:10202#145825 -R 127.0.0.1:0:10702#LoRa -H 10080 -I 1440 -u 50 -B 60 -O -n 30:$DXLPATH/netbeacon.txt -g $SERVERURL:$SERVERPORT#m/1,-t/t -p $PASSCODE -t 14580 -w 14501 -D $DXLPATH/www/ -0 -v &
